...
const Navbar = () => {
	const {currentTextColor} = useContext(ThemeContext);

	return (
		<nav className="absolute top-0 left-0 min-w-full h-fit p-4 text-center font-body z-10" style={{
			color: colorOrDefault(currentTextColor, '~frog-500'),
		}}>
			<Link href='/'>
